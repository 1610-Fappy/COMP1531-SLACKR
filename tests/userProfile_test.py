...
#Testing that everything works when everything is valid
def test_userProfile():
    ...
    assert(user_profile(user1Login['token'], user1Login['u_id']))
    ...
    assert(user_profile(user2Login['token'], user2Login['u_id']))
    ...
    assert(user_profile(user3Login['token'], user3Login['u_id']))
